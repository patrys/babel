...
''')
    ...
    def test_obsolete_message(self):
        buf = BytesIO(br'''# This is an obsolete message
#~ msgid "foo"
#~ msgstr "Voh"
...
''')
    ...
    def test_with_context(self):
        buf = BytesIO(br'''# Some string in the menu
#: main.py:1
msgctxt "Menu"
msgid "foo"
msgstr "Voh"
